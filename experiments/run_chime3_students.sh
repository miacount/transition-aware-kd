...
# Same student architecture, optimizer, data exposure, seed, and checkpoint rule.
run_paper_train paper-chime3-no-kd-s1 100 \
  --config student_base_chime3 --manifest "$PLAIN" --kd-mode none

run_paper_train paper-chime3-mass3-w25-ntdk8-s1 100 \
  --config student_base_chime3 --manifest "$MASS" --kd-mode span_kd \
