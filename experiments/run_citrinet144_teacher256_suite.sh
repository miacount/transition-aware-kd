...
run_pilot() {
  ...
  if [[ "$scope" == lbs ]]; then
    ...
    warmup=1000
    prefix=arch-citrinet144-t256-lbs
  else
    config=student_citrinet144_chime3
    plain=data/chime3_train_enhanced.json
    mass=data/chime3_train.citrinet256_adapted.d6_mass3_ntdk_m32.json
    warmup=300
    prefix=arch-citrinet144-t256-chime3
  fi
  require_file "$mass"
...
run_full() {
  ...
  if [[ "$scope" == lbs ]]; then
    ...
    config=student_citrinet144_chime3
    plain=data/chime3_train_enhanced.json
    dense=data/chime3_train.citrinet256_adapted.frame_dense_t1.json
    sctc=data/chime3_train.citrinet256_adapted.sctc.json
    carl=data/chime3_train.citrinet256_adapted.carl.json
    classifier=data/chime3_train.citrinet256_adapted.carl/teacher_classifier.pt
    warmup=300
    prefix=arch-citrinet144-t256-chime3
  fi
...
eval_scope() {
  ...
  if [[ "$scope" == lbs ]]; then
    config=configs/student_citrinet144.yaml
    prefix=arch-citrinet144-t256-lbs
    ...
    config=configs/student_citrinet144_chime3.yaml
    prefix=arch-citrinet144-t256-chime3
