...
for spec in \
  "chime3_nokd paper-chime3-no-kd-s1" \
  "chime3_mass25_ntdk8 paper-chime3-mass3-w25-ntdk8-s1"; do
  ...
  python scripts/evaluate_ctc_decoding.py \
    --ckpt "$checkpoint" --name "$label" --config configs/student_base_chime3.yaml \
